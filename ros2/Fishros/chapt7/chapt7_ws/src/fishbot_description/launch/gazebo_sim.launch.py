...
def generate_launch_description():
    ...
    default_controller_config_path = '/home/egg/fishbot_description_ws/install/fishbot_description/share/fishbot_description/config/fishbot_ros2_controller.yaml'
    # 为 Launch 声明参数
    ...
    robot_description = launch_ros.parameter_descriptions.ParameterValue(
        launch.substitutions.Command(
            ['xacro ', launch.substitutions.LaunchConfiguration('model'),
             ' controller_config_path:=' + default_controller_config_path]),
        value_type=str)
    ...
    load_fishbot_effort_controller = launch_ros.actions.Node(
        package='controller_manager',
        executable='spawner',
